...
#     def merge_idx(self,idx,ll):
#         other_ll=ll.copy_ll()
#         curr=self.get(idx-1)
#         print(other_ll,self,curr.__dict__)
#         # other_ll_tail_next=other_ll.tail.next
#         other_ll.tail.next=curr.next
#         curr.next=other_ll.head
#         self.length+=ll.length
#         # other_ll.tail.next=other_ll_tail_next
...
# #             tail.next=curr1
# #             lst.append(curr1.value)
# #             curr1=curr1.next
# #         else:
# #             tail.next=curr2
# #             lst.append(curr2.value)
# #             curr2=curr2.next
# #         tail=tail.next
# #     if curr1:
# #         lst.append(curr1.value)
...
# #     return srtd_list.next.__dict__
...
# print(srt_inp(inp))
# # other_ll=ll.copy_ll()
# # other_ll.append(1111)
# # print(ll2.merge_idx(4,other_ll),ll.length)
# ll=LinkedList()
# # print(ll.__dict__)
# ll.append('1')
# ll.append('1')
...
# # print('linked list one:',ll.__dict__) 
# # print('get:',ll.get(6).__dict__)
# # print('get:',ll.get1(5).__dict__)
# print('Pop method:',ll.pop().__dict__)
...
# # ll.merge_append(ll2)
# # print(ll.merge_append(ll2),ll.length)
# # other_ll=ll.copy_ll()
# # other_ll.append(1111)
# # print(other_ll)
# print(ll2.merge_idx(4,ll),ll.length)
# # print(merge_sort(ll,ll2))

# print('linked list one:',ll,ll.length) 
# print('linked list two:',ll2,ll2.length)  
